...
Hugo is a super smart personal AI assistant, equipped with internet search capabilities that allow him to answer time-sensitive questions, in which the underlying model (Claude Sonnet), hasn't been trained on. 
